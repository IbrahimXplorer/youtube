...
// 2: video related types
export type VideoStackParamList = {
  Video: undefined;
};

export type CategoryStackScreenProps<T extends keyof VideoStackParamList> =
  NativeStackScreenProps<VideoStackParamList, T>;

// 5: Account related types
